RSpec.describe "doubles" do
  ...
  it "sets up a double with methods" do
    ...
    # ^^ long-hand: allow(fake_object).to receive(:speak).and_return("Meow")
    # ^^ long-hand: allow(fake_object).to receive(:count_ears).and_return(2)
    # ^^ long-hand: allow(fake_object).to receive(:count_legs).and_return(4)
